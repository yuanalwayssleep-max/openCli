#!/usr/bin/env python3
"""GET /api/component-claim/get-product-list?org_id=<org_id>

中文说明：获取指定机构下的产品或核算单元候选。
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Get product/accounting-unit options.")
    parser.add_argument("--org-id", required=True, help="Org id, for example 33.")
    add_common_args(parser)
    args = parser.parse_args()
    data = call_api("GET", f"/api/component-claim/get-product-list?org_id={args.org_id}", no_open=args.no_open)
