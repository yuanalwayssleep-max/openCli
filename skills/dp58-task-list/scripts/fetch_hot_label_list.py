#!/usr/bin/env python3
"""GET /v2/task-info/fetch-hot-label-list?orgId=<org_id>
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fetch hot task labels.")
    parser.add_argument("--org-id", required=True, help="Org id, for example 33.")
    add_common_args(parser)
    args = parser.parse_args()
    data = call_api("GET", f"/v2/task-info/fetch-hot-label-list?orgId={args.org_id}", no_open=args.no_open)
